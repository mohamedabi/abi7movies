...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/2019/a18.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td colspan="2">5,0/10</td>
      <td></td>
    </tr>
       <tr>
      <th scope="row">المدى</th>
      <td colspan="2"> 1h 57min   </td>
      <td></td>
    </tr>
         <tr>
      ...
      <td></td>
        ...
        <p class="card-text">تحميل ومشاهدة فيلم What Men Want 2019 “ماذا يريد الرجال” مترجم فى اطار من الرومانسية والكوميديا والفنتازيا حول إحدى السيدات على الدوام تتعرض للتهميش في عملها من قبل وكلاء الرياضة الذكور، وإذا بها تكتسب ميزة غير متوقعة بعد تعرضها لحادث يلم بها، يجعل لديها القدرة على سماع أفكارهم، أو ما يدور بداخلهم وتتوالى الاحداث
                     </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/HeoLiTirRp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
What Men Want </div>
  <div class="card-body">
<iframe src="https://openload.co/embed/Y5UVw3FirWU/" scrolling="no" frameborder="0" width="700" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>

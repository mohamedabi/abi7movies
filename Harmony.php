...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/a12.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td colspan="2">فانتازي , رومنسي  </td>
      <td></td>
    </tr>
       <tr>
      <th scope="row">التقييم</th>
      <td colspan="2">5,4/10</td>
      <td></td>
    </tr>
       <tr>
      <th scope="row">المدى</th>
      <td colspan="2"> 1h 30min   </td>
      <td></td>
    </tr>
         <tr>
      ...
      <td></td>
        ...
        <p class="card-text">يجب أن تجد المرأة الشابة التي ولدت بقوة حيوية لامتصاص الخوف من الآخرين ، الحب لموازنة مخاوفها ومحاربة عاصفة متزايدة من الطاقة السلبية.
         </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/Fia3wDo-SWQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
Harmony & 2018  </div>
  <div class="card-body">
<iframe src="https://openload.co/embed/jSgcDMf7DV8/" scrolling="no" frameborder="0" width="700" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>

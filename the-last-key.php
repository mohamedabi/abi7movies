...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/a10.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td></td>
        ...
        <p class="card-text">تواجه أخصائية الظواهر الخارقة للطبيعة الدكتورة إيليس راينر أكبر عمل مسكون مخيف في مسيرتها على اﻹطلاق، وهذه المرة في عقر دارها، في منزلها نفسه. </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/acQyrwQyCOk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
Aquaman
  ...
  <div class="card-body">
<iframe src="https://openload.co/embed/iqoMMralu6Q/" scrolling="no" frameborder="0" width="700" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>

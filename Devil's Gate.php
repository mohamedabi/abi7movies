...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/a7.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td></td>
        ...
        <p class="card-text">ت "بوابة الشيطان" في مدينة "بوابة الشيطان" الصغيرة في شمال داكوتا يبحث الفيلم في اختفاء امرأة محلية وابنها. يساعد عميل من الف بي اي الشرطة المحلية على البحث عن اجابات فيتعقبان زوج المراة المفقودة ليدركا أنه لا شيء يبدو على حقيقته.
        </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="210" src="https://www.youtube.com/embed/01wjYvoqRkc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
Devil's Gate
  ...
  <div class="card-body">
<iframe src="https://openload.co/embed/bgsH054sZiA/" scrolling="no" frameborder="0" width="800" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>

    ...
    <div class="container-fluid" style="direction: rtl;">
      ...
      <div class="card mb-3" style="max-width: 1040px;">
        <div class="row no-gutters">
          <div class="col-md-4">
            <img src="img/a4.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
            onmouseout="ol(this) ;"
            class="card-img" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              ...
              <p class="card-text"> يذهب (بيتر باركر) وأصدقاؤه في عطلة صيفية إلى أوروبا، حيث يجد بيتر نفسه في محاولة لإنقاذ أصدقائه من يد الشرير المعروف باسم (ميستيريو).</p>
...
<div class="card text-center" style="width: 250px;  float: left; margin-top: -530px;">
    ...
    <a href="abilofilm.php"><button type="button" class="btn btn-outline-dark" ><i class="fas fa-home"></i>&nbsp; الصفحة الرئيسية</button></a>
        ...
        <div class="card-body">
          ...
          <div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="227" height="209" src="https://www.youtube.com/embed/oNE0zRNyXuc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
        </div>
      </div>
      <div class="card text-center">
        ...
        <div class="card-body">
          <iframe src="https://openload.co/embed/Bbhoac3BX4w/" scrolling="no" frameborder="0" width="1000" height="450" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
        </div>

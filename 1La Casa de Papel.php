...
<i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i><i class="fas fa-star" style="color: yellow;"></i> &nbsp;8,6/10 &nbsp;<i class="fab fa-imdb" style="font-size: 30px; float: left;"></i></td>
                    <td></td>
                  </tr>
                  <tr>
              ...
              <p class="card-text">مشاهدة مسلسل La Casa De Papel الموسم 3 الحلقة 1  فى اطار من الجريمة والاثاره حول مجموعه من اللصوص يعتدون على مصنع مونيدا وينفذون سطو اكثر مثالية فى تاريخ اسبانيا واخذ المنزل 2.400 مليون يورو
    ...
    <h5 class="card-title"><a href="series.php"><button type="button" class="btn btn-outline-danger" style="margin-top: 10px;" ><i class="fas fa-undo"></i>    الرجوع      </button></a>
      ...
      <a href="https://openload.co/f/L9fVYDUNVyY/%5BCimaClub.Com%5D-La.Casa.de.Papel.S03E01.1080p.NF.WEB-DL.mkv.mp4#"><button type="button" class="btn btn-outline-success" style="text-align: center;"><i class="fas fa-download"></i>

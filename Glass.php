...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/2019/a1.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td colspan="2">خيال علمى , اثارة , دراما  </td>
      <td></td>
    </tr>
       <tr>
      ...
      <td></td>
        ...
        <p class="card-text">تدور احدث فيلم Glass 2019 مترجم ( جلاس ) فى اطار الجريمة والخيال العلمى حيث بعد نهاية أحداث فيلم Split، يستخدم حارس الأمن (ديفيد دان) قوته الخارقة؛ للعثور على المضطرب نفسيًا (كيفين كيندل كرامب) ذو الأربعة وعشرين شخصية مختلفة.
         </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/aBL6COBGjCA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>

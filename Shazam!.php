...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/2019/a8.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td colspan="2">  مغامرة , كوميدي  , أكشن  </td>
      <td></td>
    </tr>
       <tr>
      ...
      <td></td>
        ...
        <p class="card-text">مشاهدة فيلم Shazam! 2019 مترجم فى اطار الاكشن والمغامرات حيث يدور ملخص قصة فيلم Shazam حول (بيلي باتسون) شاب يجد نفسه مالكًا لقوة الساحر شازام القادرة على محاربة قوى الشر. فمع حكمة (سليمان)، قوة (هرقل)، قدرة (أطلس) على التحمل، قوة (زيوس)، شجاعة (أخيل)، وسرعة الزئبق؛ يصبح بيلي هو كابتن (مارفل) العجيب.
          </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/-oD7B7oiBtw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
Shazam!</div>
  <div class="card-body">
<iframe src="https://openload.co/embed/DhjH_JhNx0g/" scrolling="no" frameborder="0" width="700" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>

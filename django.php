...
<div class="card mb-3" style="max-width: 1040px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      ...
      <img src="img/a8.jpg" style="opacity: 0.8;" onmouseover="ol2(this);"
onmouseout="ol(this) ;" 
 class="card-img" alt="...">
...
<td> </td>
    ...
    <tr>
      ...
      <td colspan="2"> موسيقى , دراما  </td>
      <td></td>
    </tr>
       <tr>
      <th scope="row">التقييم</th>
      <td colspan="2">6.2/10</td>
      <td></td>
    </tr>
       <tr>
      ...
      <td></td>
        ...
        <p class="card-text"> "قصة (جانغو راينهارت)، عازف الجيتار الشهير والملحن، ورحلته الشاقة مع الفن".
        </p>
...
<div class="td pda vat"><div id="yt_trailer" class="player"><iframe width="200" height="200" src="https://www.youtube.com/embed/Lw5DvTAVomA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
Django 2017
  ...
  <div class="card-body">
<iframe src="https://openload.co/embed/RhrdK2mp1s0/" scrolling="no" frameborder="0" width="700" height="430" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
